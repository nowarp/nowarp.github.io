...
```
[HIGH][pause-check-missing][rocknwa__multisig-treasury/sources/treasury.move:419:5] in function 'multisig_treasury::treasury::create_simple_proposal'
```
...
```
[HIGH][single-step-ownership][Sui-Volo__volo-liquid-staking-contracts/liquid_staking/sources/ownership.move:33:5] in function 'liquid_staking::ownership::transfer_owner'
[HIGH][single-step-ownership][Sui-Volo__volo-liquid-staking-contracts/liquid_staking/sources/ownership.move:47:5] in function 'liquid_staking::ownership::transfer_operator'
```
...
```
[MEDIUM][centralized-reward-distribution][dravynn__sui-smartcontract/sources/core.move:147:5] in function 'rtmtree::longshot_jackpot::goal_shot'
```
...
```
[INFO][admin-bypasses-pause][naviprotocol__navi-smart-contracts/lending_core/sources/pool.move:228:5] in function 'lending_core::pool::withdraw_treasury'
```
...
```
[INFO][missing-admin-event][lukeleppan__patience/sources/patience.move:160:5] in function 'patience::patience::withdraw_fee' - extracts value. Emit event with: amount
[INFO][missing-admin-event][lukeleppan__patience/sources/patience.move:166:5] in function 'patience::patience::admin_transfer' - transfers to user-controlled address. Emit event with: recipient
[INFO][missing-admin-event][moose-labs__anglerfish/contracts/core/sources/prize_pool.move:161:1] in function 'anglerfish::prize_pool::claim_protocol_fee' - extracts value. Emit event with: amount
[INFO][missing-admin-event][moose-labs__anglerfish/contracts/core/sources/prize_pool.move:172:1] in function 'anglerfish::prize_pool::claim_treasury_reserve' - extracts value. Emit event with: amount
```
...
```
[MEDIUM][missing-mutable-config-setter][satlayer__satlayer-sui/core/sources/satlayer_pool.move:55:1] field 'satlayer_core::satlayer_pool::Vault.min_deposit_amount'
```
...
```
[MEDIUM][missing-mutable-config-setter][angel10x__Sui-Pump--Move/sources/curve.move:42:5] field 'pumpfun::curve::Configurator.swap_fee'
```
...
```
[HIGH][mutable-protocol-invariant][Suigar-Gaming__suigar-contracts/sources/lootbox.move:118:5] in function 'suigar::lootbox::edit_lootbox' writes to invariant 'suigar::lootbox::LootBox.reward_amounts'
[HIGH][mutable-protocol-invariant][Suigar-Gaming__suigar-contracts/sources/lootbox.move:118:5] in function 'suigar::lootbox::edit_lootbox' writes to invariant 'suigar::lootbox::LootBox.reward_probabilities'
```
...
* Many projects do not have publicly available source code; almost no commits corresponding to findings mentioned in audit reports remain accessible.
...
## References
1. [Xia et al – AuditGPT: Auditing Smart Contracts with ChatGPT (2004)](https://arxiv.org/pdf/2404.04306)
